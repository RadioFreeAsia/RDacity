...
bool Exporter::JustInitValidate(AudacityProject *project, bool selectedOnly, double t0, double t1)
{
   // This is a Init process so that we can check for validity ONLY (No Exporting done here)
   mProject = project;
